...
%
%	Cnt is the total number of memoized pairs of consecutive prime numbers.
...
prime_mem_fill(Sup) :-
	must_be(posint, Sup),
	G = ignore(forall(prime_lgc:gen_(2, Sup, _), true)),
	prime_mem:fill_(G, Sup).
...
:- thread_initialization(prime_mem_fill(100_000)).		% TODO: Review this. #####
